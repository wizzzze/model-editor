...
( function () {
	...
	Object.assign( THREE.FBXLoader.prototype, {
		...
		parse: function ( FBXBuffer, resourceDirectory ) {
			...
			var materials = parseMaterials( FBXTree, connections );
	...
	function loadTexture( textureNode, loader, images, connections ) {
		...
		if ( textureNode.FileName.slice( -3 ).toLowerCase() === 'tga' ) {
			console.log(THREE.Loader.Handlers);
	...
	function parseMaterials( FBXTree, connections ) {
		...
		if ( 'Material' in FBXTree.Objects ) {
			...
			for ( var nodeID in materialNodes ) {
				...
				var material = parseMaterial( FBXTree, materialNodes[ nodeID ], connections );
	...
	function parseMaterial( FBXTree, materialNode, connections ) {
